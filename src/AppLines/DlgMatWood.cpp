...
CDlgMatWood::CDlgMatWood(b3Item *item, CAppObjectDoc *pDoc, CWnd* pParent /*=NULL*/)
...
{
	CDlgMatWood dlg(item, (CAppObjectDoc *)ptr);
...
void CDlgMatWood::b3PostInitDialog()
{
	...
	m_MatSampler = new b3MaterialSampler(m_PreviewMaterialCtrl, &m_BBox->m_DimSize);
