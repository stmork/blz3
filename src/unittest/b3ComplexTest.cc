...
void b3ComplexTest::testStdComplex32()
{
	...
	b3_c32 *= 6.0f;
	CPPUNIT_ASSERT_EQUAL( 21.0f, b3_c32.b3Real());
	CPPUNIT_ASSERT_EQUAL( 12.0f, b3_c32.b3Imag());

	b3_c32 /= 3.0f;
	CPPUNIT_ASSERT_EQUAL(  7.0f, b3_c32.b3Real());
	CPPUNIT_ASSERT_EQUAL(  4.0f, b3_c32.b3Imag());

	b3_c32 -= 1.5;
	CPPUNIT_ASSERT_EQUAL(  5.5f, b3_c32.b3Real());
	CPPUNIT_ASSERT_EQUAL(  4.0f, b3_c32.b3Imag());

	// 32 bit init tests

	b3Complex<b3_f32>    b3_c32_init1(std_c32);
	b3Complex<b3_f32>    b3_c32_init2(b3_c32);

	CPPUNIT_ASSERT_EQUAL( 1.0f, b3_c32_init1.b3Real());
	CPPUNIT_ASSERT_EQUAL( 7.0f, b3_c32_init1.b3Imag());
	...
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0.724324, b3_c32.b3Real(), 0.0001);
	CPPUNIT_ASSERT_DOUBLES_EQUAL(0.745946, b3_c32.b3Imag(), 0.0001);
	...
	b3_c32 = b3_c32_init1 * b3_c32_init2;
	CPPUNIT_ASSERT_EQUAL(-22.5f, b3_c32.b3Real());
	CPPUNIT_ASSERT_EQUAL( 42.5f, b3_c32.b3Imag());

	b3_c32 *= b3_c32_init1;
	CPPUNIT_ASSERT_EQUAL(-320.0f, b3_c32.b3Real());
	CPPUNIT_ASSERT_EQUAL(-115.0f, b3_c32.b3Imag());

	b3Complex<b3_f32>::b3Swap(b3_c32_init1, b3_c32_init2);
	CPPUNIT_ASSERT_EQUAL( 5.5f, b3_c32_init1.b3Real());
	CPPUNIT_ASSERT_EQUAL( 4.0f, b3_c32_init1.b3Imag());
	CPPUNIT_ASSERT_EQUAL( 1.0f, b3_c32_init2.b3Real());
	CPPUNIT_ASSERT_EQUAL( 7.0f, b3_c32_init2.b3Imag());

	b3_c32_init2 = b3_c32.b3Scale(b3_c32_init1);
	CPPUNIT_ASSERT_EQUAL( 5.5f,    b3_c32_init1.b3Real());
	CPPUNIT_ASSERT_EQUAL( 4.0f,    b3_c32_init1.b3Imag());
	CPPUNIT_ASSERT_EQUAL(-1760.0f, b3_c32.b3Real());
	CPPUNIT_ASSERT_EQUAL( -460.0f, b3_c32.b3Imag());
	CPPUNIT_ASSERT_EQUAL(b3_c32,   b3_c32_init2);

	b3_c32.b3Dump("c32 test");

	std::string message = b3_c32;
	CPPUNIT_ASSERT(message.length() > 0);
}

void b3ComplexTest::testStdComplex64()
{
	...
	b3_c64 += 2.5;
	CPPUNIT_ASSERT_EQUAL( 5.5, b3_c64.b3Real());
	CPPUNIT_ASSERT_EQUAL( 4.0, b3_c64.b3Imag());

	b3_c64 *= 6.0;
	CPPUNIT_ASSERT_EQUAL( 33.0, b3_c64.b3Real());
	CPPUNIT_ASSERT_EQUAL( 24.0, b3_c64.b3Imag());

	b3_c64 /= 3.0;
	CPPUNIT_ASSERT_EQUAL( 11.0, b3_c64.b3Real());
	CPPUNIT_ASSERT_EQUAL(  8.0, b3_c64.b3Imag());

	b3_c64 -= 6.5;
	CPPUNIT_ASSERT_EQUAL( 4.5, b3_c64.b3Real());
	CPPUNIT_ASSERT_EQUAL( 8.0, b3_c64.b3Imag());

	b3Complex64    b3_c64_init1(std_c64);
	b3Complex64    b3_c64_init2(b3_c64);

	CPPUNIT_ASSERT_EQUAL( 2.5, b3_c64_init1.b3Real());
	CPPUNIT_ASSERT_EQUAL( 3.5, b3_c64_init1.b3Imag());
	CPPUNIT_ASSERT_EQUAL( 4.5, b3_c64_init2.b3Real());
	CPPUNIT_ASSERT_EQUAL( 8.0, b3_c64_init2.b3Imag());

	b3Complex64::b3Swap(b3_c64_init1, b3_c64_init2);
	CPPUNIT_ASSERT_EQUAL( 4.5, b3_c64_init1.b3Real());
	...
	b3_c64_init2 = b3_c64.b3Scale(b3_c64_init1);
	CPPUNIT_ASSERT_EQUAL( 4.5,   b3_c64_init1.b3Real());
	CPPUNIT_ASSERT_EQUAL( 8.0,   b3_c64_init1.b3Imag());
	CPPUNIT_ASSERT_EQUAL(20.25,  b3_c64.b3Real());
	CPPUNIT_ASSERT_EQUAL(64.0,   b3_c64.b3Imag());
	CPPUNIT_ASSERT_EQUAL(b3_c64, b3_c64_init2);

	b3_c64_init2 = b3_c64.b3Sqrt();
	CPPUNIT_ASSERT_EQUAL( 4.5,   b3_c64_init2.b3Real());
	CPPUNIT_ASSERT_EQUAL( 8.0,   b3_c64_init2.b3Imag());
	CPPUNIT_ASSERT_EQUAL(20.25,  b3_c64.b3Real());
	CPPUNIT_ASSERT_EQUAL(64.0,   b3_c64.b3Imag());
