...
class SctUnitRunner {
	public:
		SctUnitRunner(sc::StatemachineInterface * statemachine, bool event_driven, sc::integer cycle_period);
...
class SctUnitRunner::SctTimer {
	...
	public:
		SctTimer(sc::integer time_ms, bool periodic, sc::eventid evid, sc::integer priority, bool is_runcycle);
		~SctTimer(){}
