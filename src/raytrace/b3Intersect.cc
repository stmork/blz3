...
b3_f64 b3Area::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	...
	m_Polar.polar.x = m_Polar.object_polar.x = aValue;
	m_Polar.polar.y = m_Polar.object_polar.y = bValue;
	m_Polar.polar.z = m_Polar.object_polar.z = 0;

	return b3CheckStencil() ? lValue : -1;
}

b3_f64 b3Disk::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	b3_f64     Denom,aValue,bValue,lValue;
	b3_vector  Dir,Product;
	...
	m_Polar.polar.x	= b3RelAngleOfScalars(aValue,bValue);
	m_Polar.polar.y	= sqrt (Denom);
	m_Polar.polar.z	= 0;
	m_Polar.object_polar.x = aValue;
	m_Polar.object_polar.y = bValue;
	m_Polar.object_polar.z = 0;

	return b3CheckStencil() ? lValue : -1;
}

b3_f64 b3Sphere::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	...
	if (l1 > 0)
	{
		...
		m_Polar.polar.x = acos(b3AngleOfVectors (&m_Dir,&n) /
			sin(p)) * 0.5 / M_PI;
		m_Polar.polar.y = p * 2.0 / M_PI - 1.0;
		m_Polar.polar.z = 0;
		if (b3AngleOfVectors(&aux,&n) < 0)
		{
			m_Polar.polar.x = 1.0 - m_Polar.polar.x;
		}

		if (b3CheckStencil ())
		{
			p = sqrt(m_QuadRadius);
			m_Polar.object_polar.x = n.x / p;
			m_Polar.object_polar.y = n.y / p;
			m_Polar.object_polar.z = n.z / p;
			return l1;
		}
	}
...
b3_f64 b3Cylinder::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	b3_dLine BTLine;
	...
	if (l1 > 0)
	{
		...
		m_Polar.object_polar.x = BTLine.pos.x + l1 * BTLine.dir.x;
		m_Polar.object_polar.y = BTLine.pos.y + l1 * BTLine.dir.y;
		m_Polar.object_polar.z = BTLine.pos.z + l1 * BTLine.dir.z;

		m_Polar.polar.x = b3RelAngleOfScalars(
			m_Polar.object_polar.x,
			m_Polar.object_polar.y);
		m_Polar.polar.y = m_Polar.object_polar.z;
		m_Polar.polar.z = 0;
		if (b3CheckStencil())
		{
			return l1;
	...
	if (l2 > 0)
	{
		...
		m_Polar.object_polar.x = BTLine.pos.x + l2 * BTLine.dir.x;
		m_Polar.object_polar.y = BTLine.pos.y + l2 * BTLine.dir.y;
		m_Polar.object_polar.z = BTLine.pos.z + l2 * BTLine.dir.z;
...
b3_f64 b3Cone::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	b3_dLine BTLine;
	b3_f64   l1,l2,z,Discriminant,a,p;
...
b3_f64 b3Ellipsoid::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	b3_dLine  BTLine;
	b3_f64    l1,l2,z,Discriminant,a,p;
	...
	if (l1 > 0)
	{
		...
		m_Polar.polar.x	= b3RelAngleOfScalars(
			m_Polar.object_polar.x,
			m_Polar.object_polar.y);
		m_Polar.polar.y	= asin(m_Polar.object_polar.z) * 2.0 / M_PI;
		m_Polar.polar.z	= 0;
		if (b3CheckStencil())
		{
			return l1;
...
b3_f64 b3Box::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	b3_dLine   BTLine;
	...
	m_Polar.polar.x = m_Polar.object_polar.x = x;
	m_Polar.polar.y = m_Polar.object_polar.y = y;
	m_Polar.polar.z = m_Polar.object_polar.z = BTLine.pos.z + l1 * BTLine.dir.z;

	m_Normal = m_Normals[n[0]];
	return l1;
}

b3_f64 b3Torus::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3TriangleShape::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3SplineArea::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3SplineCylinder::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3SplineRing::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3SplineCurveShape::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3SplineRotShape::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3CSGSphere::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3CSGCylinder::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3CSGCone::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3CSGEllipsoid::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}

b3_f64 b3CSGBox::b3Intersect(b3_dLine *ray,b3_f64 &Q)
{
	return -1;
}
