...
b3SplineRotShape::b3SplineRotShape(const b3_u32 class_type) :
...
b3SplineRotShape::b3SplineRotShape(const b3_u32 * src) :
	b3TriangleShape(src)
{
	m_rSubDiv = b3InitInt();
	...
	m_Controls = m_Mem.b3TypedAlloc<b3_vector>(m_Spline.m_ControlMax);
