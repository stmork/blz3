...
b3CSGEllipsoid::b3CSGEllipsoid(const b3_u32 class_type) : b3CSGShape3(sizeof(b3CSGEllipsoid), class_type)
{
}

b3CSGEllipsoid::b3CSGEllipsoid(const b3_u32 * src) : b3CSGShape3(src)
{
}
